...
module "project" {
  source          = "github.com/dapperlabs-platform/terraform-google-project?ref=tag"
...
module "dataset" {
  source     = "github.com/terraform-google-modules/cloud-foundation-fabric/modules/bigquery-dataset"
  project_id = var.project_id
  id         = "bq_sink"
}

module "pubsub" {
  source     = "github.com/terraform-google-modules/cloud-foundation-fabric/modules/pubsub"
  project_id = var.project_id
  name       = "pubsub_sink"
}
